...
#   REPO_FULL_NAME    — owner/repo (e.g. nonflux/integration-service)
#   ISSUE_NUMBER      — GitHub issue number
#   REPO_DIR          — path to extracted repo (default: current directory)
#
# Optional environment variables:
#   PUSH_TOKEN_SOURCE — "github-app" or "pat" (for logging; default: unknown)
#
# Exit codes:
...
# Setup
# ---------------------------------------------------------------------------
# When invoked by the fullsend CLI (post_script), cwd is the run directory
# and the extracted repo is at repo/. When invoked as a workflow step, the
# caller sets REPO_DIR=. and CDs into target-repo beforehand.
